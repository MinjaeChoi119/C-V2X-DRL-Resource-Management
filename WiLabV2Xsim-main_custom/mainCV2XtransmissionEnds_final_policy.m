...
if ~isempty(stationManagement.transmittingIDsCV2X)   
    ...
    [stationManagement,sinrManagement,outputValues,simValues] = updateKPICV2X_final_policy(activeIDsTXLTE,indexInActiveIDsOnlyLTE,awarenessID_LTE,neighborsID_LTE,timeManagement,stationManagement,positionManagement,sinrManagement,outputValues,outParams,simParams,appParams,phyParams,simValues);
