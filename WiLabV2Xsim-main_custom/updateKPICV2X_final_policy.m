function [stationManagement,sinrManagement,outputValues,simValues] = updateKPICV2X_final_policy(activeIDsTXLTE,indexInActiveIDsOnlyLTE,awarenessID_LTE,neighborsID_LTE,timeManagement,stationManagement,positionManagement,sinrManagement,outputValues,outParams,simParams,appParams,phyParams,simValues)

outputValues.reception = 0;  % reception 초기화
outputValues.totalPacket = 0;  % totalPacket 초기화
...
for iPhyRaw=1:length(phyParams.Raw)
    ...
    %for iChannel = 1:phyParams.nChannels
        %for pckType = 1:appParams.nPckTypes
            ...
            outputValues.reception = NcorrectlyTxBeacons; % 안재욱 해당 시점의 성공한 패킷 저장
    ...
    %for iChannel = 1:phyParams.nChannels
        %for pckType = 1:appParams.nPckTypes
            ...
            outputValues.totalPacket = NtxBeacons; % 안재욱 해당 시점의 전체 패킷 저장
