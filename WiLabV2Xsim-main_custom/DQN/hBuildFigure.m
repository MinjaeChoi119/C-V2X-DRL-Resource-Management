function [f, lineReward,lineAveReward, lineEpsilon, pointEpisode, lineQValueAction1, lineQValueAction2, lineMaxQValueAction, lineExperienceMSE, lineEpisodeMSE] = hBuildFigure()
...
%     subplot()
    ...
    legend(ax2,'Action 1 - Q-Value','Action 2 - Q-Value', 'Max Q-Value','Location','southwest')
