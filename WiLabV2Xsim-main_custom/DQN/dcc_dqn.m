...
obsInfo = rlNumericSpec([2, 1], 'LowerLimit', [-Inf; 0], 'UpperLimit', [Inf; 1]); % rho에는 제한 없음, CBR은 0~1로 제한
obsInfo.Name = "DCC Example Observation";
obsInfo.Description = "rho, CBR"; 
actInfo = rlFiniteSetSpec([1 0.03 0.006 0.003]);
actInfo.Name = "CR_limit"; 
actInfo.Description = "Packet_generation_Control";
first_decay_episode = true;
last_decay_episode = true; 
env = rlFunctionEnv(obsInfo, actInfo, 'myDCCStepFunction', 'myDCCResetFunction');
