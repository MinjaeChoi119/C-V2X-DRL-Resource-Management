function [timeManagement,stationManagement,sinrManagement,CBRvalues,coex_cbrLTEonlyValues,CRvalue] = cbrUpdateCV2X_final_policy_90(timeManagement,vehiclesToConsider,stationManagement,positionManagement,sinrManagement,appParams,simParams,phyParams,outParams,outputValues)
...
if simParams.dcc_active
    ...
    CRlimit = (1*(simParams.rho<172*phyParams.cv2xCbrFactor) + 0.006*(simParams.rho>=172*phyParams.cv2xCbrFactor & simParams.rho<193*phyParams.cv2xCbrFactor) + 0.003*( simParams.rho>=193*phyParams.cv2xCbrFactor))*phyParams.cv2xCbrFactor;
