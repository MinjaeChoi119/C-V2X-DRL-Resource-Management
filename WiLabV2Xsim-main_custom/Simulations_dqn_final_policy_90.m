...
%rho_values = [100:10:170, 171:199, 200:10:360];
rho_values = [100:10:170, 171:199, 200:10:360];
...
for rho = rho_values
    ...
    outputFolder = sprintf('Output/raw200/CRlimit_final_policy_90/LTEV2X_%dMHz_DQN_rho_%d', BandMHz, rho);

    WiLabV2Xsim_final_policy_90(configFile,'outputFolder',outputFolder,'Technology','LTE-V2X','MCS_LTE',MCS,'beaconSizeBytes',packetSize,...
