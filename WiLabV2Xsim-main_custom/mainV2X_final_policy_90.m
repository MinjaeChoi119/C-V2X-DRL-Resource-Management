function [simValues,outputValues,appParams,simParams,phyParams,sinrManagement,outParams,stationManagement, culmulativeCBRvalues, culmulativeCRvalues, culmulativePRR] = mainV2X_final_policy_90(appParams,simParams,phyParams,outParams,simValues,outputValues,positionManagement)
...
%             %% =========
        ...
        if ~isempty(stationManagement.activeIDsCV2X)
            ...
            [timeManagement,stationManagement,sinrManagement,stationManagement.cbrCV2Xvalues(vehiclesToConsider,ceil(timeEvent/simParams.cbrSensingInterval)),stationManagement.coex_cbrLteOnlyValues(vehiclesToConsider,ceil(timeEvent/simParams.cbrSensingInterval)),CRvalue] = ...
                cbrUpdateCV2X_final_policy_90(timeManagement,vehiclesToConsider,stationManagement,positionManagement,sinrManagement,appParams,simParams,phyParams,outParams,outputValues);
